...
export default async function SettingsPage() {
  ...
  const [
    ...
    supabase.from('profiles').select('id,email,full_name,avatar_url,username,phone,timezone,currency,travel_mode_currency,default_monthly_budget,subscription_status,stripe_customer_id,stripe_subscription_id,trial_ends_at,subscription_ends_at,theme_preference,created_at,updated_at').eq('id', user.id).single(),
