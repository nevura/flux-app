...
const PM_CARDS: Record<string, { bg: string; shadow: string }> = {
  'MP-EFECTIVO': { bg: 'linear-gradient(135deg, #00ad40ff 0%, #00ad40ff 100%)', shadow: '0 4px 20px rgba(46,175,87,0.10)' },
  'MP-TDD': { bg: 'linear-gradient(135deg, #007AFF 0%, #007AFF 100%)', shadow: '0 4px 20px rgba(0,122,255,0.10)' },
  'MP-TDC': { bg: 'linear-gradient(135deg, #FF8A80 0%, #FF8A80 100%)', shadow: '0 4px 20px rgba(223,73,217,0.10)' },
}
...
export default function DashboardClient({ user, accounts, transactions, categories, scheduled, budget, people, creditPayments, year, month }: Props) {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#020617' }}>
      ...
      >
        <p className="text-[10px] font-black tracking-[3px] uppercase" style={{ color: 'rgba(255,255,255,0.35)' }}>
      ...
      <div className="px-4 pt-4 space-y-7 max-w-lg mx-auto pb-32">
        ...
        <div
          ...
          style={{ background: '#007AFF', boxShadow: '0 8px 32px rgba(0,122,255,0.35)' }}
        >
        ...
        <div
          ...
          style={{
            background: budgetAmount > 0
              ? budgetOver
                ? 'linear-gradient(135deg, rgba(255,69,58,0.10) 0%, rgba(255,69,58,0.03) 100%)'
                : 'linear-gradient(135deg, rgba(0,122,255,0.10) 0%, rgba(0,122,255,0.03) 100%)'
              : '#0F172A',
            border: budgetAmount > 0
              ? budgetOver ? '1px solid rgba(255,69,58,0.18)' : '1px solid rgba(0,122,255,0.15)'
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              <p className="text-[11px] font-black tracking-[1.5px] uppercase" style={{ color: 'rgba(255,255,255,0.4)' }}>
                Presupuesto del mes
              </p>
            </div>
            <div className="flex items-center gap-2">
              {!budgetEditOpen && (
                ...
                >
                  <i className="fa-solid fa-pencil text-white" style={{ fontSize: 10 }} />
                </button>
              )}
            </div>
          </div>
          ...
          {budgetEditOpen ? (
            <div className="flex gap-2">
              <input
                ...
                placeholder="0.00"
                autoFocus
                className="flex-1 rounded-[12px] px-3 py-2.5 text-[15px] font-black text-white outline-none tabular-nums"
                style={{ background: 'rgba(255,255,255,0.07)', border: '1px solid rgba(0,122,255,0.4)' }}
                inputMode="decimal"
            ...
            <p className="text-[12px] font-bold" style={{ color: 'rgba(255,255,255,0.3)' }}>
        ...
        <div
          ...
          style={{ background: '#0F172A', border: '1px solid rgba(255,255,255,0.08)', animationDelay: '0.06s' }}
        >
          <div className="flex border-b" style={{ borderColor: 'rgba(255,255,255,0.07)' }}>
            {(['daily', 'weekly'] as const).map(v => (
              <button
                ...
                style={{
                  color: spendView === v ? '#007AFF' : 'rgba(255,255,255,0.35)',
                  borderBottom: spendView === v ? '2px solid #007AFF' : '2px solid transparent',
                }}
              >
                {v === 'daily' ? 'Hoy' : 'Semana'}
              </button>
          ...
          <div className="px-5 py-4">
            <p className="text-center text-[11px] font-bold capitalize mb-3" style={{ color: 'rgba(255,255,255,0.4)' }}>
        ...
        {scheduled.length > 0 && (() => {
          ...
          return (
            <div
              ...
              style={{ background: '#0F172A', border: '1px solid rgba(255,255,255,0.08)', animationDelay: '0.08s' }}
            >
              <p className="text-[11px] font-black tracking-[3px] uppercase mb-4" style={{ color: 'rgba(255,255,255,0.4)' }}>
              ...
              {totalIncomes > 0 && (
                <div className={totalExpenses > 0 ? 'mt-4 mb-3' : 'mb-3'}>
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-[11px] font-black tracking-[2px] uppercase" style={{ color: 'rgba(48,209,88,0.7)' }}>Ingresos</p>
                    <p className="text-[14px] font-black tabular-nums leading-none" style={{ color: '#30D158' }}>
                  ...
                  <div className="flex justify-between">
                    ...
                    {totalIncomes - receivedIncomes > 0 && (
                      <p className="text-[12px] font-bold tabular-nums" style={{ color: 'rgba(255,255,255,0.35)' }}>
              ...
              {totalExpenses > 0 && (
                <div className="mb-3">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-[11px] font-black tracking-[2px] uppercase" style={{ color: 'rgba(255,69,58,0.7)' }}>Gastos</p>
                    <p className="text-[14px] font-black tabular-nums leading-none" style={{ color: '#FF453A' }}>
              ...
              <div className="space-y-3">
                {upcomingList.map((s, i) => {
                  ...
                  const amtColor = isExpense ? '#FF453A' : isIncome ? '#30D158' : '#64D2FF'
                  return (
                    <button
                      key={s.id}
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        ...
                        <i className="fa-solid fa-chevron-right text-[9px]" style={{ color: 'rgba(255,255,255,0.2)' }} />
                      </div>
                    </button>
                  )
                })}
        ...
        <div className="animate-fade-up" style={{ animationDelay: '0.12s' }}>
          <div className="flex items-center justify-between mb-3">
            <p className="text-[10px] font-black tracking-[3px] uppercase" style={{ color: 'rgba(255,255,255,0.4)' }}>
              Estado de cuentas
            </p>
            <button
              ...
              style={{ background: 'rgba(0,122,255,0.15)', color: '#007AFF', border: '1px solid rgba(0,122,255,0.3)' }}
            >
        ...
        {creditCards.length > 0 && (
          <div className="animate-fade-up" style={{ animationDelay: '0.16s' }}>
            <p className="text-[10px] font-black tracking-[3px] uppercase mb-3" style={{ color: 'rgba(255,255,255,0.4)' }}>
              Pagos TDC
            </p>
            <div className="rounded-[20px] overflow-hidden" style={{ background: '#0F172A', border: '1px solid rgba(255,255,255,0.08)' }}>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {isSkipped ? (
                        ...
                        <p className="text-[11px]" style={{ color: isOverdue ? '#FF453A' : 'rgba(255,255,255,0.4)' }}>
                          {dueDay != null
                            ? isOverdue
                    ...
                    <div className="flex-shrink-0">
                      {isPaid ? (
                        ...
                        <span
                          className="px-2.5 py-1 rounded-full text-[10px] font-black"
                          style={{
                            background: isOverdue ? 'rgba(255,69,58,0.12)' : 'rgba(0,122,255,0.15)',
                            color: isOverdue ? '#FF453A' : '#007AFF',
                          }}
                        >
      ...
      {scheduledAction && (
        <>
          ...
          <div
            ...
            style={{ background: '#0F172A', paddingBottom: 'calc(2rem + var(--safe-bottom))' }}
          >
            <div className="flex items-center gap-3 mb-5">
              <div className="flex-1 min-w-0">
                <p className="text-[16px] font-black text-white truncate">{scheduledAction.name}</p>
        ...
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 pt-5 pb-4">
              <div>
                <p className="text-[15px] font-black text-white">{tdcModal.name}</p>
            ...
            <div className="px-5 space-y-4 pb-2">
              {/* Amount */}
              <div>
                <p className="text-[10px] font-black tracking-[2px] uppercase mb-2" style={{ color: 'rgba(255,255,255,0.4)' }}>
                  Monto pagado
                </p>
                <input
                  type="number"
                  ...
                  className="w-full rounded-[14px] px-4 py-3.5 text-[17px] font-black text-white outline-none tabular-nums"
                  ...
                  <div className="space-y-2">
                    {nonTdcAccounts.map(a => (
                      ...
                      >
                        ...
                        {tdcSource === a.id && (
                          <i className="fa-solid fa-check text-xs flex-shrink-0" style={{ color: '#007AFF' }} />
                        )}
                      </button>
                    ))}
                  </div>
