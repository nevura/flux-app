...
export const GUIDE_SECTIONS: GuideSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        tip: '⚠️ Para Atajos de iPhone: el nombre de la cuenta debe coincidir EXACTAMENTE con el nombre de tu tarjeta en Wallet. Verifícalo en Configuración → Wallet y Apple Pay → Tarjetas de pago',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        tip: '⚠️ Importante: el nombre de tus cuentas en Flux debe coincidir EXACTAMENTE con el nombre en Wallet → Apple Pay → Tarjetas de pago, o el atajo no encontrará la cuenta correcta',
      },
    ],
  },
]
